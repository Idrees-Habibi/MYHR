<div>
        ...
        <div class="card-header">
            <div class="text-end">
                <button type="button" class="btn btn-primary btn-sm"
                    wire:click="$dispatchTo('employee.employee-education-modal', 'showBranchModal',{ id: 0 })"><i
                        ...
                        <tr>
                            ...
                            <td class="table-action">
                                <a href="javascript: void(0);" class="action-icon"
                                    wire:click="$dispatchTo('employee.employee-education-modal', 'showBranchModal',{ id: {{ $branch->id }} })">
    ...
    <livewire:employee.employee-education-modal />
</div>
